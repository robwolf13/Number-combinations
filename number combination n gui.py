...
#below creates a simple gui to display the results

top = Tk()
L1 = Label(top, text="Starting Numbers")
L1.pack(side = TOP)
E1 = Entry(top, bd=5, textvariable = StringVar())
E1.pack()
B1 = Button(top, text="Calculate Answers", command=start)
B1.pack()
S1 = Scrollbar(top)
T1 = Text(top)
